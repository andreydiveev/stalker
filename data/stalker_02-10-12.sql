...
--
-- Хост: localhost
-- Время создания: Сен 26 2012 г., 03:14
...
INSERT INTO `user` (`id`, `email`, `password`, `nick`, `reg_date`, `last_activity`, `total_time`, `frag`, `squad`, `expo`, `level`, `current_hp`, `current_area`, `cash`, `alive`) VALUES
(1, 'admin12@ya.ru', 'e10adc3949ba59abbe56e057f20f883e', 'Admin', 1348471986, 0, 0, 0, NULL, 0, 0, 0, NULL, 0, 1),
(2, 'admin@stalker.ru', '4297f44b13955235245b2497399d7a93', 'AAd', 1348472004, 1348654469, 0, 0, NULL, 0, 0, 0, 5, 590, 1),
(3, '', '', 'vendor', 0, 0, 0, 0, NULL, 0, 0, 0, NULL, 0, 1);
...
INSERT INTO `user_equipment` (`id`, `user_id`, `slot_id`, `equipment_id`, `equipped`) VALUES
(2, NULL, 1, 1, 0),
(3, 2, 1, 1, 0),
(8, 2, 2, 2, 0),
(9, 2, 2, 2, 0);
